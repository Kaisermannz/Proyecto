...
class Comunidad:
    ...
    def crear_grupos(self, promedio_grupos_por_persona, min_personas_por_grupo, max_personas_por_grupo):
        # Crear grupos de ciudadanos 
        ciudadanos_lista = list(self.__ciudadanos.values())  # Convertir el diccionario de ciudadanos en una lista
        num_ciudadanos = len(ciudadanos_lista)  # Número total de ciudadanos

        # Calcular el número total de slots y el número de grupos
        ...
        # Asignar ciudadanos a grupos aleatoriamente
        ...
        # Asegurar que cada grupo tenga al menos el número mínimo de personas
        ...
        # Crear conexiones entre ciudadanos dentro de los mismos grupos
        for grupo in self.__grupos:
        ...
        # Limitar el número máximo de conexiones a 50
        max_conexiones = 50
        for ciudadano in ciudadanos_lista:
    ...
    def infectar_aleatoriamente(self, num_infectados, enfermedad):
        # Infectar a un número aleatorio de ciudadanos
    ...
    def simular_contagio_dias(self):
        # Simular el proceso de contagio en todos los ciudadanos
    ...
    def generar_grafica(self):
        ...
        plt.plot(dias, susceptibles, label='Susceptibles', color='blue', linestyle='--')
        plt.plot(dias, infectados, label='Infectados (actuales)', color='red')
        plt.plot(dias, recuperados, label='Recuperados', color='green', linestyle='--')
